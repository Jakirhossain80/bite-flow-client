    ...
    <div className="my-12 flex flex-wrap items-center justify-center gap-6 pt-14">
      <div className="text-sm w-80 border border-gray-200 pb-6 rounded-lg bg-white shadow-[0px_4px_15px_0px] shadow-black/5">
        ...
        <p className="text-gray-500 px-6 text-center">
          I&apos;ve been visiting BiteFlow regularly, and every dish feels
          freshly crafted with care. The ambiance and service make each visit
          memorable.
        </p>
      ...
      <div className="text-sm w-80 border border-gray-200 pb-6 rounded-lg bg-white shadow-[0px_4px_15px_0px] shadow-black/5">
        ...
        <p className="text-gray-500 px-6 text-center">
          BiteFlow&apos;s menu is a perfect mix of comfort food and modern
          flavors. My followers love the dishes I share from here.
        </p>
        <div className="flex justify-center pt-4">
          <div className="flex gap-0.5">
            {[...Array(5)].map((_, index) => (
      ...
      <div className="text-sm w-80 border border-gray-200 pb-6 rounded-lg bg-white shadow-[0px_4px_15px_0px] shadow-black/5">
        ...
        <p className="text-gray-500 px-6 text-center">
          Our team dinners at BiteFlow are always a hit. Great food, fast
          service, and an easy booking experience through the platform.
        </p>
        <div className="flex justify-center pt-4">
          <div className="flex gap-0.5">
            {[...Array(5)].map((_, index) => (
